		...
		<div>
			<div className="p-6 overflow-scroll">
				...
				<div className="text-black mt-6">
					...
					<div className="mt-3">
						<label for="default-search" class="mb-2 text-sm text-gray-900 dark:text-white font-bold">
						...
						<div class="relative">
							...
							<input
								type="search"
								id="default-search"
								class="block w-full pl-10 py-3 pr-3 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
				...
				<div className="text-black mt-6">
					<h6 class="mb-2 text-sm text-gray-900 dark:text-white font-bold">My Cards</h6>
				...
				<div className="text-black mt-3">
					<h6 class="mb-2 text-sm text-gray-900 dark:text-white font-bold">Last Transfers</h6>
					{lastTransfers.map((item, index) => {
						return (
							<div className="flex items-center mt-3 cursor-pointer" onClick={props.goToPay}>
				...
				<div className="text-black mt-3">
					<h6 class="mb-2 text-sm text-gray-900 dark:text-white font-bold">A</h6>
				...
				<div className="text-black mt-3">
					<h6 class="mb-2 text-sm text-gray-900 dark:text-white font-bold">B</h6>
					{aGroup.map((item, index) => {
						return (
							<div className="flex items-center mt-3 cursor-pointer" onClick={props.goToPay}>
								<img src={item.avatar} width={50} height={50} className="rounded-xl" />
